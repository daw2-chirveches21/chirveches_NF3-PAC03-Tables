...
VALUES 
    ...
    (2, "2008-07-25", "Jordi Egea", "This is the best movie. I
        didn't wear my flair to the movie but I loved it anyway.", 3),
    (2, "2008-04-13", "Eric Chirveches", "This is a bad movie. I
    ...
    (3, "2008-09-29", "Joel Lara", "I prefer to do php than to watch the movie again", 1),
    (3, "2008-09-23", "Masha F", "I liked this movie", 3)
ENDSQL;
mysqli_query($db, $query) or die(mysqli_error($db));
